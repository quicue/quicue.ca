...
Auto-generated provider template for gitea.

## Resource types

Matches resources with any of: `GitForge, SourceControl`
...
providers: {
    gitea: {
        types: { /* ... */ }
        registry: patterns.#GiteaRegistry
    }
}
```
...
3. Validate: `cue vet ./template/gitea/...`
