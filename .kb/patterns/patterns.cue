...
p_graph_projection: core.#Pattern & {
	...
	example:  "homelab/graph.cue: 65 lines, reads proxmox_cluster and k8s_cluster, produces 9 resources across 5 layers. Original config.cue, schemas/, and CI are unmodified."
	used_in: {
		"homelab": true
	}
	related: {
